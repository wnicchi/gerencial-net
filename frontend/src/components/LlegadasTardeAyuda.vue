<!-- LlegadasTardeAyuda.vue — Ayuda del módulo Llegadas Tarde por Período. -->
<template>
  <div class="vca-ov" @click.self="$emit('close')">
    <div class="vca-modal">
      <button class="vca-x" @click="$emit('close')">✕</button>
      <div class="vca-hero">
        <svg viewBox="0 0 120 80" class="vca-svg"><circle cx="60" cy="40" r="22" class="vca-clock" /><line x1="60" y1="40" x2="60" y2="26" class="vca-min" /><line x1="60" y1="40" x2="70" y2="46" class="vca-hr" /><circle cx="60" cy="40" r="3" class="vca-center" /></svg>
        <h2>Llegadas Tarde</h2><p>Tardanzas y salidas anticipadas</p>
      </div>
...
defineEmits(['close'])
const pasos = [
  { t: 'Filtrá y traé empleados', d: 'Elegí empresa, traé la lista y seleccioná a quiénes analizar.' },
  { t: 'Configurá los parámetros', d: 'Rango de fechas y los minutos posteriores a la llegada/salida considerados “tarde”.' },
  { t: 'Generá el informe', d: 'Compara cada marcación con el horario del turno y muestra los minutos de llegada tarde, salida tarde y la diferencia.' },
  { t: 'Opciones', d: 'Podés incluir los negativos (minutos a favor) y ver un resumido con el total por empleado. Se imprime o exporta a PDF.' },
]
</script>
<style scoped>
