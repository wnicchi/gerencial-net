<!-- RelojGruposAyuda.vue — Ayuda del módulo Grupos de Turnos Laborales. -->
<template>
  <div class="vca-ov" @click.self="$emit('close')">
    <div class="vca-modal">
      <button class="vca-x" @click="$emit('close')">✕</button>
      <div class="vca-hero">
        <svg viewBox="0 0 120 80" class="vca-svg"><circle cx="60" cy="40" r="22" class="vca-clock" /><line x1="60" y1="40" x2="60" y2="26" class="vca-min" /><line x1="60" y1="40" x2="71" y2="46" class="vca-hr" /><circle cx="60" cy="40" r="3" class="vca-center" /></svg>
        <h2>Grupos de Turnos</h2><p>Definir los horarios de cada turno</p>
      </div>
...
defineEmits(['close'])
const pasos = [
  { t: 'Elegí o creá un grupo', d: 'Tocá un grupo de la lista o “Nuevo”. Cada grupo se identifica por su descripción y se asigna a empleados.' },
  { t: 'Cargá los turnos', d: 'Cada grupo tiene hasta 3 turnos. Por cada día (de domingo a sábado) tildá el día y poné la hora Desde y Hasta (formato HH:MM).' },
  { t: 'Rotación', d: 'Si el grupo tiene más de un turno, “Rotar cada N días al turno N” define cómo van rotando. El sistema computa el primer día hábil del mes respecto al Turno 1.' },
  { t: 'Guardá', d: 'Con “Crear” / “Guardar” se registra. Estos horarios son los que usa el cálculo de horas trabajadas.' },
]
</script>
<style scoped>
...
.vca-svg { width:120px; height:80px; } .vca-clock { fill:rgba(255,255,255,.12); stroke:#fff; stroke-width:2.6; } .vca-min { stroke:#fff; stroke-width:2.6; stroke-linecap:round; } .vca-hr { stroke:rgba(255,255,255,.85); stroke-width:2.4; stroke-linecap:round; } .vca-center { fill:#fde68a; }
