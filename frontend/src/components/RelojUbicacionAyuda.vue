<!-- RelojUbicacionAyuda.vue — Ayuda del módulo Reloj Ubicación. -->
<template>
  <div class="vca-ov" @click.self="$emit('close')">
    <div class="vca-modal">
      <button class="vca-x" @click="$emit('close')">✕</button>
      <div class="vca-hero">
        <svg viewBox="0 0 120 80" class="vca-svg"><path d="M60 16 a16 16 0 0 1 16 16 c0 12 -16 30 -16 30 c0 0 -16 -18 -16 -30 a16 16 0 0 1 16 -16 Z" class="vca-pin" /><circle cx="60" cy="32" r="6" class="vca-hole" /></svg>
        <h2>Reloj Ubicación</h2><p>Dónde están los relojes de personal</p>
      </div>
...
defineEmits(['close'])
const pasos = [
  { t: 'Qué es', d: 'Es el listado de las ubicaciones físicas de los relojes donde el personal ficha (por ejemplo "Rosario").' },
  { t: 'Crear / editar', d: 'Elegí “Nueva” o tocá una ubicación de la lista, escribí la descripción y guardá. Se guarda en mayúsculas.' },
  { t: 'Eliminar', d: 'Con la ubicación seleccionada, usá “Eliminar”.' },
]
</script>
<style scoped>
...
.vca-svg { width:120px; height:80px; } .vca-pin { fill:rgba(255,255,255,.18); stroke:#fff; stroke-width:2.4; } .vca-hole { fill:#1b4332; stroke:#fde68a; stroke-width:2; }
