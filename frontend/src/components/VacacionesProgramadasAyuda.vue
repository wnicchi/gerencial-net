<!-- VacacionesProgramadasAyuda.vue — Ayuda del módulo Vacaciones Programadas. -->
<template>
    ...
    <div class="vca-modal">
      ...
      <div class="vca-hero">
        <svg viewBox="0 0 120 80" class="vca-svg">
          <rect x="34" y="20" width="52" height="44" rx="4" class="vca-cal" />
          <line x1="34" y1="32" x2="86" y2="32" class="vca-line" />
          <line x1="46" y1="14" x2="46" y2="26" class="vca-ring" />
          <line x1="74" y1="14" x2="74" y2="26" class="vca-ring" />
          <circle cx="56" cy="48" r="5" class="vca-dot" />
        </svg>
        <h2>Vacaciones Programadas</h2>
        <p>Las vacaciones de mañana en adelante</p>
      </div>
      <div class="vca-body">
...
defineEmits(['close'])
const pasos = [
  { t: 'Qué se muestra', d: 'Todos los períodos cuyo inicio o fin es de mañana en adelante, con el legajo, el personal y los días que le corresponden por antigüedad.' },
  { t: 'Seleccioná', d: 'Tildá las filas que querés incluir, o usá “Todos” / “Ninguno”.' },
  { t: 'Imprimí o exportá', d: 'Generá el PDF de los registros seleccionados o exportalos a Excel (se abre el diálogo Guardar como).' },
]
</script>
...
.vca-cal { fill:rgba(255,255,255,.15); stroke:#fff; stroke-width:2.4; } .vca-line { stroke:#fff; stroke-width:2.4; } .vca-ring { stroke:#fff; stroke-width:3; stroke-linecap:round; }
.vca-dot { fill:#fde68a; animation:vca-pulse 1.8s ease-in-out infinite; }
@keyframes vca-pulse { 0%,100% { opacity:.6 } 50% { opacity:1 } }
